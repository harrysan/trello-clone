  ...
  <div class="h-full flex flex-col items-stretch" :class="bgColor">
    ...
    >
      <div class="ml-2 w-1/3">
        <UserBoardsDropdownVue v-if="isLoggedIn"></UserBoardsDropdownVue>
      </div>
...
import UserBoardsDropdownVue from "./components/UserBoardsDropdown.vue";
...
export default {
  components: { List, UserBoardsDropdownVue, ListAddEditor },
  computed: {
    bgColor() {
      return {
